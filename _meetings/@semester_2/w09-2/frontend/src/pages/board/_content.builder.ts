export class ContentBuilder {
    ...
    private static templateCard(cardElement) {
    ...
    private static templateCardBuilder(cardCollection) {
    ...
    private static templateColumn(element) {
    ...
    private static templateColumnBuilder (collection) {
