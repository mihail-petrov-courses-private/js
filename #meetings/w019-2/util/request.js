...
DispatcherManager.prototype.getHeader = function(name = "") {
    console.log(this.httpRequest.headers);
    return this.httpRequest.headers[name.toLowerCase()];
}
...
DispatcherManager.prototype.getAuthorized = function() {

    try {
        const authTokken = this.getHeader('Authorized');
        return authService.verify(authTokken);
    }
    catch( error ) {
        return null;
    }
...
DispatcherManager.prototype.isAuthorized = function() {
